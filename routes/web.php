...
Route::get('access/generate_passwords', [
    'as' => 'generate_passwords', 'uses' => 'LoginController@generate_passwords'
]);

Route::get('access/send_credentials', [
    'as' => 'send_credentials', 'uses' => 'LoginController@send_credentials'
]);